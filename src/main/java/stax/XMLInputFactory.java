...
import stax.util.XMLEventAllocator;
 ...
 *        <th>Required</th>
 *      </tr>
 * <tr><td>stax.isValidating</td><td>Turns on/off implementation specific DTD validation</td><td>Boolean</td><td>False</td><td>No</td></tr>
 * <tr><td>stax.isNamespaceAware</td><td>Turns on/off namespace processing for XML 1.0 support</td><td>Boolean</td><td>True</td><td>True (required) / False (optional)</td></tr>
 * <tr><td>stax.isCoalescing</td><td>Requires the processor to coalesce adjacent character data</td><td>Boolean</td><td>False</td><td>Yes</td></tr>
 * <tr><td>stax.isReplacingEntityReferences</td><td>replace internal entity references with their replacement text and report them as characters</td><td>Boolean</td><td>True</td><td>Yes</td></tr>
 *<tr><td>stax.isSupportingExternalEntities</td><td>Resolve external parsed entities</td><td>Boolean</td><td>Unspecified</td><td>Yes</td></tr>
 *<tr><td>stax.supportDTD</td><td>Use this property to request processors that do not support DTDs</td><td>Boolean</td><td>True</td><td>Yes</td></tr>
 *<tr><td>stax.reporter</td><td>sets/gets the impl of the XMLReporter </td><td>stax.XMLReporter</td><td>Null</td><td>Yes</td></tr>
 *<tr><td>stax.resolver</td><td>sets/gets the impl of the XMLResolver interface</td><td>stax.XMLResolver</td><td>Null</td><td>Yes</td></tr>
 *<tr><td>stax.allocator</td><td>sets/gets the impl of the XMLEventAllocator interface</td><td>stax.util.XMLEventAllocator</td><td>Null</td><td>Yes</td></tr>
 *    </tbody>
 *  </table>
 *
 *
 ...
 * @see XMLReporter
 * @see XMLResolver
 * @see stax.util.XMLEventAllocator
 */
...
public abstract class XMLInputFactory {
  ...
  public static final String IS_REPLACING_ENTITY_REFERENCES=
    "stax.isReplacingEntityReferences";
  
  /** 
   *  The property that requires the parser to resolve external parsed entities
   */
  public static final String IS_SUPPORTING_EXTERNAL_ENTITIES=
    "stax.isSupportingExternalEntities";
   ...
   * Use the stax.XMLInputFactory system property.
   ...
   * The Services API will look for a classname in the file META-INF/services/stax.XMLInputFactory
