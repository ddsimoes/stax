 ...
 *        <th>Required</th>
 *              </tr>
 *         <tr><td>stax.isRepairingNamespaces</td><td>defaults prefixes on the output side</td><td>Boolean</td><td>False</td><td>Yes</td></tr>
 *      </tbody>
 *   </table>
 *
 ...
 * <code>setProperty("stax.isRepairingNamespaces",new Boolean(true|false));</code></p>
 * 
...
public abstract class XMLOutputFactory {
  ...
  {
    return (XMLOutputFactory) FactoryFinder.find("stax.XMLOutputFactory",
                                                 "stax.impl.ZephyrWriterFactory");
  }
