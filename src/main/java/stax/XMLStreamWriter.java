 ...
 *
 * If stax.isPrefixDefaulting is set to false it is a fatal error if an element
 * is written with namespace URI that has not been bound to a prefix.
 *
 * If stax.isPrefixDefaulting is set to true the XMLStreamWriter implementation
...
public interface XMLStreamWriter {
   ...
   * stax.isPrefixDefaulting has not been set to true
   */
