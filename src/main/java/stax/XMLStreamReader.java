 ...
 * stax.notations and stax.entities.
 * When the current event is a DTD the following call will return a
 * list of Notations
 *  <code>List l = (List) getProperty("stax.notations");</code>
 * The following call will return a list of entity declarations:
 * <code>List l = (List) getProperty("stax.entities");</code>
...
public interface XMLStreamReader extends XMLStreamConstants {
   ...
   * If the property stax.isCoalescing is set to true
   ...
   * Regardless of value of stax.isCoalescing this method always returns coalesced content.
