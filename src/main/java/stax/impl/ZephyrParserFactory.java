...
public class ZephyrParserFactory extends stax.XMLInputFactory {
    ...
    XMLStreamReader getXMLStreamReaderImpl(XMLInputSource inputSource) throws stax.XMLStreamException{
