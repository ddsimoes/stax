...
import stax.impl.events.EntityDeclarationImpl;
import stax.impl.events.NotationDeclarationImpl;
...
import stax.impl.xerces.util.NamespaceContextWrapper;
import stax.impl.xerces.util.SymbolTable;
import stax.impl.dtd.nonvalidating.XMLNotationDecl;
import stax.impl.dtd.nonvalidating.DTDGrammar;
import java.util.ArrayList;
import java.util.Enumeration;
import java.util.Hashtable;
import java.util.Iterator;
import java.util.List;
import stax.XMLInputFactory;
import stax.XMLStreamConstants;
import stax.XMLStreamException;
import stax.impl.xerces.util.XMLChar;
import stax.impl.xerces.util.XMLStringBuffer;
import org.xml.sax.InputSource;
import javax.xml.XMLConstants;



/** This class implements stax.XMLStreamReader. It makes use of XML*Scanner classes to
 ...
 */
public class XMLReaderImpl implements stax.XMLStreamReader {
     ...
     * @return
     */
    public javax.xml.namespace.QName convertXNIQNametoJavaxQName(stax.impl.xerces.xni.QName qname){
