...
import stax.impl.PropertyManager;
...
public class XMLEventAllocatorImpl implements XMLEventAllocator {
    ...
    public stax.events.XMLEvent allocate(stax.XMLStreamReader xMLStreamReader) throws stax.XMLStreamException {
    ...
    public void allocate(stax.XMLStreamReader xMLStreamReader, stax.util.XMLEventConsumer xMLEventConsumer) throws stax.XMLStreamException {
    ...
    public stax.util.XMLEventAllocator newInstance() {
