 ...
 * Attribute object of type stax.Attribute internally. It would avoid the need of creating
 * new stax.Attribute object at the later stage.
 *
...
public class XMLAttributesIteratorImpl extends XMLAttributesImpl implements Iterator {
    ...
    public Object next() {
        if(hasNext()){
            // should this be of type stax.Attribute ?
     ...
     */
    /*
    class AttributeImpl extends stax.impl.xerces.util.XMLAttributesImpl.Attribute implements stax.events.Attribute{
