...
public class NamespaceContextWrapper implements NamespaceContext {
    ...
    private stax.impl.xerces.xni.NamespaceContext fNamespaceContext;
    
    public NamespaceContextWrapper(stax.impl.xerces.xni.NamespaceContext namespaceContext) {
     ...
     */
    public stax.impl.xerces.xni.NamespaceContext getNamespaceContext() {
